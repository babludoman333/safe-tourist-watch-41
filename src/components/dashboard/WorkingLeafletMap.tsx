...
// Fix for default markers in react-leaflet - ensure this runs immediately
...
const WorkingLeafletMap: React.FC<WorkingLeafletMapProps> = ({ 
  locations, 
  height = "400px",
  onLocationClick 
}) => {
  console.log('WorkingLeafletMap rendering with', locations.length, 'locations');
  ...
  // Default center coordinates (New York)
      ...
      <Card className="shadow-soft">
        ...
        <CardContent>
          <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-6 text-center">
            ...
            <p className="text-destructive font-semibold mb-2">Unable to load interactive map</p>
  ...
  try {
    ...
    setMapError(error.message || 'Unknown error occurred');
    return null;
  }
};
